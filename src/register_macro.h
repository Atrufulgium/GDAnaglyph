...
// To register e.g. `set_distance(const float arg)` in AnaglyphEffect, you need to do:
// REGISTER(FLOAT, distance, AnaglyphEffect, "godot_name", PROPERTY_HINT_RANGE, "0.1,10,0.1,suffix:m")
...
// To register e.g. `set_distance(const float arg)` in AnaglyphEffect, you need to do:
// REGISTER(FLOAT, distance, AnaglyphEffect, "godot_name", PROPERTY_HINT_RANGE, "0.1,10,0.1,suffix:m", PROPERTY_USAGE_DEFAULT)
